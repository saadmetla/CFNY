...
(function () {
  ...
  // Background is left to style.css so the bar stays opaque over content.
  const hdr = document.querySelector('.site-header');
  if (hdr) {
    hdr.style.cssText += ';position:fixed!important;top:0!important;left:0!important;width:100%!important;z-index:1000!important;';
  }

  const s = document.createElement('style');
  s.textContent = `
    .site-header { position: fixed !important; top: 0 !important; left: 0 !important; width: 100% !important; }
    .cf-lines {
